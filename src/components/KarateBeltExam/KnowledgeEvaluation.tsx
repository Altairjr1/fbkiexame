...
export const KnowledgeEvaluation: React.FC<KnowledgeEvaluationProps> = ({
  student,
  onScoreChange,
  onNotesChange,
  score,
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input 
              ...
              placeholder="Nome do examinador de Conhecimentos"
              className="mt-1"
            />
          </div>
          ...
          <div className="space-y-2 mt-4">
            ...
            <Textarea
              ...
              placeholder="Adicione observações sobre o desempenho teórico..."
